...
const colormaps_diverging = Dict{String, Any}(
    ...
    "brbg"     => ( 54.1, 186.5, 0.16, 1.0,  0.38, 0.83, 0.50, 0.58, RGB(0.7, 0.8, 0.8), RGB(0.7, 0.4, 0.1), RGB(0.2, 0.8, 0.3)),
    "piyg"     => (334.9, 111.7, 0.09, 1.0,  1.0,  0.78, 0.48, 0.81, RGB(0.8, 0.7, 0.8), RGB(0.9, 0.2, 0.5), RGB(0.2, 0.7, 0.2)),
    "prgn"     => (281.6, 136.8, 0.20, 0.73, 1.0,  0.85, 0.33, 0.52, RGB(0.9, 0.8, 0.8), RGB(1.0, 0.0, 1.0), RGB(0.0, 0.7, 0.0)),
    "rdbu"     => ( 12.0, 255.0, 0.2,  0.6,  0.0,  0.85, 0.6,  0.65, RGB(1.0, 1.0, 0.0), RGB(1.0, 0.0, 0.0), RGB(0.0, 0.0, 1.0)),
    "rdylgn"   => (351.0, 130.2, 0.97, 1.0,  0.13, 0.71, 0.51, 0.67, RGB(1.0, 1.0, 0.5), RGB(0.8, 0.0, 0.0), RGB(0.4, 0.0, 0.4)),
    "spectral" => (344.1, 263.3, 1.0,  1.0,  0.85, 0.77, 0.57, 0.80, RGB(1.0, 1.0, 0.5), RGB(0.7, 0.0, 0.2), RGB(0.1, 0.0, 0.1)),
)
